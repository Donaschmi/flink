 ...
 */
package org.apache.flink.runtime.rest.handler.job.charon;
...
import org.apache.flink.runtime.rest.messages.job.charon.CharonUpdateHeaders;
 ...
 */
public class CharonUpdateHandler
        extends AbstractRestHandler<
        RestfulGateway,
        CharonBody,
        EmptyResponseBody,
        JobMessageParameters> {
    public CharonUpdateHandler(
        ...
        super(
                ...
                timeout,
                responseHeaders,
                CharonUpdateHeaders.INSTANCE);
    }
    @Override
    protected CompletableFuture<EmptyResponseBody> handleRequest(
            @Nonnull HandlerRequest<CharonBody> request,
