 ...
 */
public class TopSpeedWindowingWithSSG {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final SlotSharingGroup ssgWithResourceA =
                SlotSharingGroup.newBuilder("ssgA")
                        .setCpuCores(0.5) // required
                        .setTaskHeapMemoryMB(100) // required
                        .setManagedMemory(MemorySize.ofMebiBytes(200))
                        .build();

        final SlotSharingGroup ssgWithResourceB =
                SlotSharingGroup.newBuilder("ssgB")
                        .setCpuCores(0.5) // required
                        .setTaskHeapMemoryMB(200) // required
                        .setManagedMemory(MemorySize.ofMebiBytes(50))
                        .build();
        ...
        if (params.getInputs().isPresent()) {
            ...
            LoggerFactory.getLogger(TopSpeedWindowingWithSSG.class).debug("ssgA");
            carData =
                    env.addSource(CarSource.create(2))
                            .name("in-memory-source")
                            .slotSharingGroup(ssgWithResourceB);
        }
        ...
        DataStream<Tuple4<Integer, Integer, Double, Long>> topSpeeds =
                carData.assignTimestampsAndWatermarks(
                        ...
                        .maxBy(1)
                        .slotSharingGroup(ssgWithResourceA);
